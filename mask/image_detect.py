...
if __name__ == "__main__":
    ...
    parser.add_argument("--input_file_path", type=str, default="Picture/", help="path to images directory")
    parser.add_argument("--output_path", type=str, default="Picture/", help="output image directory")
